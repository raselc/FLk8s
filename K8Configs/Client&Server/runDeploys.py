...
if __name__ == '__main__':
    ...
    if args.num == 'start':
        ...
        os.system("kubectl apply -f test_c7.yaml")
        os.system("kubectl apply -f test_c8.yaml")
        os.system("kubectl apply -f test_c9.yaml")
        os.system("kubectl apply -f test_c10.yaml")
        print("All started")
    if args.num == 'end':
        ...
        os.system("kubectl delete -f test_c7.yaml")
        os.system("kubectl delete -f test_c8.yaml")
        os.system("kubectl delete -f test_c9.yaml")
        os.system("kubectl delete -f test_c10.yaml")
        print("deleted")