...
class FLServer(object):
    # TODO: the setting for the experimentation
    MIN_NUM_WORKERS = 1
    MAX_NUM_ROUNDS = 5
    ...
    def register_handles(self):
        ...
        def handle_client_ready(data):
            ...
            new_client = [request.sid, data['client_time_zone'], data['client_ID']]
        ...
        def handle_client_update(data):
            ...
            if data['round_number'] == self.current_round:
                ...
                if request.sid in self.client_sids_selected_resources:
        ...
        def handle_client_eval(data):
            ...
            if len(self.eval_client_updates) == self.ready_client.__len__():
                ...
                print('\nExecution Time: ', time.time() - self.start_time, "seconds")
                print("== done ==")
    ...
    def get_correct_clients_then_train(self):
        ...
        for x in self.all_clients_resources:
            ...
            if self.sufficient_resources(x['client_ID'], res_df, x['train_and_valid_size']):
                ...
                self.client_sids_selected_resources.append(x['client_sid'])
            else:
    ...
    def train_next_round(self):
        ...
        self.client_sids_randomly_selected = random.sample(list(self.ready_client['sID']),
        ...
        for rid in self.client_sids_randomly_selected:
            emit('request_update', {
                'model_id': self.model_id,
